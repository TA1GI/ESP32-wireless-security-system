...
const char* PHONE = "+905555555555";

// Initialize Wifi connection to the router
const char* ssid = "XXX";     // your network SSID (name)
const char* password = "12345678"; // your network key

// Initialize Telegram BOT
const char* BOTtoken = "xxx:xxx"; // your Bot Token (Get from Botfather)
const char* chat_id = "111111"; // your telegram user id (to chat with)
